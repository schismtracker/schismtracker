...
You will also need the [SDL2 MinGW development library](https://github.com/libsdl-org/SDL/releases). If you unpacked it
...
System](http://nsis.sourceforge.net/), copy some files into your build directory:
...
different [AUR helper](https://wiki.archlinux.org/index.php/AUR_helpers). `mingw-w64-sdl2` may or may not be necessary if
