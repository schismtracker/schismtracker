...
enum {
	SCHISM_KEYMOD_NONE = (1u << 0),
	SCHISM_KEYMOD_LCTRL = (1u << 1),
	SCHISM_KEYMOD_RCTRL = (1u << 2),
	SCHISM_KEYMOD_LSHIFT = (1u << 3),
	SCHISM_KEYMOD_RSHIFT = (1u << 4),
	SCHISM_KEYMOD_LALT = (1u << 5),
	SCHISM_KEYMOD_RALT = (1u << 6),
	SCHISM_KEYMOD_LGUI = (1u << 7),
	SCHISM_KEYMOD_RGUI = (1u << 8),
	SCHISM_KEYMOD_NUM = (1u << 9),
	SCHISM_KEYMOD_CAPS = (1u << 10),
	SCHISM_KEYMOD_MODE = (1u << 11),
	SCHISM_KEYMOD_SCROLL = (1u << 12),
