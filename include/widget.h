...
void widget_create_listbox(struct widget *w,
	uint32_t (*i_size) (struct widget_context *this),
	int (*i_toggled) (struct widget_context *this, uint32_t),
	const char * (*i_name) (struct widget_context *this, uint32_t),
	void (*i_changed) (struct widget_context *this),
	void (*i_activate) (struct widget_context *this),
