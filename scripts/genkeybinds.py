...
keycodes = Keybinds([
	...
	Keybind("EJECT"),
	Keybind("SLEEP"),
	Keybind("APP1", SDLVersion(2, 0, 6)),
	Keybind("APP2", SDLVersion(2, 0, 6)),
	Keybind("AUDIOREWIND", SDLVersion(2, 0, 6)),
	Keybind("AUDIOFASTFORWARD", SDLVersion(2, 0, 6)),
	Keybind("SOFTLEFT", SDLVersion(2, 24, 0)),
	Keybind("SOFTRIGHT", SDLVersion(2, 24, 0)),
	Keybind("CALL", SDLVersion(2, 24, 0)),
	Keybind("ENDCALL", SDLVersion(2, 24, 0)),
