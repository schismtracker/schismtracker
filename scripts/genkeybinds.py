...
class Keybind:
	...
	sdl_version: SDLVersion = dataclasses.field(default_factory=SDLVersion)
...
scancodes = Keybinds([
	...
	Keybind("KP_PERIOD"),
	Keybind("KP_EQUALS"),
], "SDL_Scancode", "US_", "SDL_SCANCODE_", "SDL_SCANCODE_UNKNOWN");
...
keycodes = Keybinds([
	...
	Keybind("EJECT"),
	Keybind("SLEEP"),
	Keybind("APP1", sdl_version=SDLVersion(2, 0, 6)),
	Keybind("APP2", sdl_version=SDLVersion(2, 0, 6)),
	Keybind("AUDIOREWIND", sdl_version=SDLVersion(2, 0, 6)),
	Keybind("AUDIOFASTFORWARD", sdl_version=SDLVersion(2, 0, 6)),
	Keybind("SOFTLEFT", sdl_version=SDLVersion(2, 24, 0)),
	Keybind("SOFTRIGHT", sdl_version=SDLVersion(2, 24, 0)),
	Keybind("CALL", sdl_version=SDLVersion(2, 24, 0)),
	Keybind("ENDCALL", sdl_version=SDLVersion(2, 24, 0)),
], "SDL_Keycode", "", "SDLK_", "SDLK_UNKNOWN")
 ...
 */\n\n""")
	...
	for i in ["it.h", "util.h", "charset.h"]:
		f.write("#include \"%s\"\n" % i)
	f.write("\n")
