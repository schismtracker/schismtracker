...
static struct menu settings_menu = {
        x: 22, y: 28, w: 30, title: "Settings Menu",
...
static void _draw_menu(struct menu *menu)
{
        ...
        while (n--) {
                ...
                draw_text_len((const unsigned char *)menu->items[n], menu->w, 4 + menu->x, 5 + menu->y + 3 * n,
...
static void settings_menu_selected_cb(void)
{
	...
	case 1: /* midi configuration */
                set_page(PAGE_MIDI);
		return;
	case 2: /* palette configuration */
                set_page(PAGE_PALETTE_EDITOR);
		return;
	case 3: /* font editor */
		set_page(PAGE_FONT_EDIT);
		return;
	case 4: /* toggle fullscreen */
