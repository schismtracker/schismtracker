...
static void do_ins_save(void *p)
{
	...
	else status_text_flash("Error: Instrument %d NOT saved! (No Filename?)", current_instrument);
	free(ptr);
}
...
static void instrument_save(void)
{
	...
	if (os_stat(ptr, &buf) == 0) {
		if (S_ISDIR(buf.st_mode)) {
			...
			dialog_create(DIALOG_OK_CANCEL, "Overwrite file?", do_ins_save, free, 1, ptr);
			return;
		} else {
...
static void instrument_list_handle_alt_key(struct key_event *k)
{
	...
	case SDLK_o: instrument_save(); return;
...
static void _load_page_common(struct page *page, struct widget *page_widgets)
{
	...
	create_togglebutton(page_widgets + 4, 68, 13, 7, 4, 5, 3, 0, 0, change_subpage, "Pitch", 2, subpage_switches_group);
}
...
void instrument_list_general_load_page(struct page *page)
{
	...
	create_textentry(widgets_general + 17, 56, 47, 13, 13, 17, 0, update_filename, NULL, 12);
}
...
void instrument_list_volume_load_page(struct page *page)
{
	...
	create_toggle(widgets_volume + 6, 54, 28, 5, 7, 0, 0, 0, instrument_list_volume_update_values);
	create_toggle(widgets_volume + 7, 54, 29, 6, 8, 0, 0, 0, instrument_list_volume_update_values);

	/* 8-10 envelope loop settings */
	create_toggle(widgets_volume + 8, 54, 32, 7, 9, 0, 0, 0, instrument_list_volume_update_values);
	create_numentry(
	...
	create_toggle(widgets_volume + 11, 54, 37, 10, 12, 0, 0, 0, instrument_list_volume_update_values);
	create_numentry(
	...
	create_thumbbar(widgets_volume + 14, 54, 42, 17, 13, 15, 0, instrument_list_volume_update_values, 0, 128);
	create_thumbbar(widgets_volume + 15, 54, 43, 17, 14, 16, 0, instrument_list_volume_update_values, 0, 256);
	create_thumbbar(widgets_volume + 16, 54, 46, 17, 15, 16, 0, instrument_list_volume_update_values, 0, 100);
}
...
void instrument_list_panning_load_page(struct page *page)
{
	...
	/* 6-7 = envelope switches */
	create_toggle(widgets_panning + 6, 54, 28, 5, 7, 0, 0, 0, instrument_list_panning_update_values);
	create_toggle(widgets_panning + 7, 54, 29, 6, 8, 0, 0, 0, instrument_list_panning_update_values);

	/* 8-10 envelope loop settings */
	create_toggle(widgets_panning + 8, 54, 32, 7, 9, 0, 0, 0, instrument_list_panning_update_values);
	create_numentry(
	...
	/* 11-13 = susloop settings */
	create_toggle(widgets_panning + 11, 54, 37, 10, 12, 0, 0, 0, instrument_list_panning_update_values);
	create_numentry(
	...
	create_toggle(widgets_panning + 14, 54, 42, 13, 15, 0, 0, 0, instrument_list_panning_update_values);
	create_thumbbar(widgets_panning + 15, 54, 43, 9, 14, 16, 0, instrument_list_panning_update_values, 0, 64);
	...
	create_thumbbar(widgets_panning + 17, 54, 46, 9, 16, 18, 0, instrument_list_panning_update_values, -32, 32);
	create_thumbbar(widgets_panning + 18, 54, 47, 9, 17, 18, 0, instrument_list_panning_update_values, 0, 64);
}
...
void instrument_list_pitch_load_page(struct page *page)
{
	...
	create_toggle(widgets_pitch + 7, 54, 29, 6, 8, 0, 0, 0, instrument_list_pitch_update_values);

	/* 8-10 envelope loop settings */
	create_toggle(widgets_pitch + 8, 54, 32, 7, 9, 0, 0, 0, instrument_list_pitch_update_values);
	create_numentry(
	...
	/* 11-13 = susloop settings */
	create_toggle(widgets_pitch + 11, 54, 37, 10, 12, 0, 0, 0, instrument_list_pitch_update_values);
	create_numentry(
	...
	create_thumbbar(widgets_pitch + 14, 54, 42, 17, 13, 15, 0, instrument_list_pitch_update_values, -1, 127);
	create_thumbbar(widgets_pitch + 15, 54, 43, 17, 14, 16, 0, instrument_list_pitch_update_values, -1, 127);
	...
	create_thumbbar(widgets_pitch + 17, 54, 45, 17, 16, 18, 0, instrument_list_pitch_update_values, -1, 127);
	create_thumbbar(widgets_pitch + 18, 54, 46, 17, 17, 19, 0, instrument_list_pitch_update_values, -1, 127);
	create_thumbbar(widgets_pitch + 19, 54, 47, 17, 18, 19, 0, instrument_list_pitch_update_values, -1, 127);
